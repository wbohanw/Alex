...
3. **Plan phase** — Alex runs an OpenCode session against your remote server and posts an implementation plan as an issue comment.
...
- Remote OpenCode server for all LLM work
